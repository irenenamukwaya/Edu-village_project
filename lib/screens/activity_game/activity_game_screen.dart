...
class _ActivityGameScreenState extends State<ActivityGameScreen> {
  late List<ActivityQuestion> questions = [];
  ...
  Future<void> _loadQuestions() async {
    final allQuestions = await QuestionService.loadActivityQuestions();
  ...
  Future<void> _onAnswerSelected(String answer) async {
    ...
    setState(() {
      ...
      feedbackMessage = isCorrect
          ? 'Wonderful! That is the right activity.'
          : 'Not quite. Try again and look closely at the picture.';
    });
              ...
              QuestionCard(
                ...
                imageWidget: Padding(
                  ...
                  child: InteractivePictureCard(
                    ...
                    caption: currentQuestion.description,
                    fallbackEmoji: '🎬',
